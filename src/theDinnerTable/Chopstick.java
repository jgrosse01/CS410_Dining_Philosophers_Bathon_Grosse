...
public class Chopstick {
   ...
   * @param pos defines where a {@code Chopstick} is to be placed on a theoretical
   *            table of dining philosophers.
   */
  Chopstick(int pos) {
    this.pos = pos;
    inUse = false;
   ...
   * 
   * @return A String representing the instance of {@code Chopstick} which calls
   *         this method.
   */
  ...
  /**
   * @desc A boolean check to see if the {@code Chopstick} is being held by a
   *       philosopher.
   * 
  ...
  /**
   * @desc A synchronized method to pickup {@code Chopstick} objects and throw an
   *       error if the {@code Chopstick} is in use.
   */
