...
public class Table {
  ...
  // gets range of positions of chopsticks available to a philosopher at position
  // pos
  ...
  /**
   * @desc Method to remove rice from the bowl so a {@code Philosopher} may eat
   *       it.
   * @param request The amount of rice requested by a {@code Philosopher}.
   * @return The amount of rice taken from the bowl (minimum of the request and
